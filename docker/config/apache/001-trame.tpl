<VirtualHost *:80>
  ...
  RewriteRule ^TRAME_URL_PREFIX/api/(.*)/original-image/(.*)$  http://${session-to-port:$1}/original-image/$2  [P,L]
  RewriteRule ^TRAME_URL_PREFIX/api/(.*)/transform-image/(.*)$  http://${session-to-port:$1}/transform-image/$2  [P,L]
