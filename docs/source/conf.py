...
Notes:
    ...
    cd ~/code/nrtk-explorer/docs
    sphinx-apidoc --private --separate --force --output-dir ~/code/nrtk-explorer/docs/source/auto ~/code/nrtk-explorer/src/nrtk_explorer
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/nrtk-explorer/advanced/
        ...
        Enter the following information:
            Set the Repository NAME: nrtk-explorer
            Set the Repository URL: https://github.com/Kitware/nrtk-explorer

        Make sure you have a .readthedocs.yml file

        For gitlab you also need to setup an integrations. Navigate to:

            https://readthedocs.org/dashboard/nrtk-explorer/integrations/create/
        ...
        Then go to
            ...
            https://github.com/Kitware/nrtk-explorer/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/nrtk-explorer/versions/
"""
...
project = "nrtk-explorer"
copyright = "2024, Kitware"
author = "Kitware"
modname = "nrtk_explorer"

repo_dpath = dirname(dirname(dirname(__file__)))
mod_dpath = join(repo_dpath, "src", "nrtk_explorer")
src_dpath = dirname(mod_dpath)
modpath = join(mod_dpath, "__init__.py")
# release = parse_version(modpath)  # TODO: better parsing of version
release = "0.4.0"
...
# html_logo = '.static/nrtk-explorer.svg'
# html_favicon = '.static/nrtk-explorer.ico'
...
latex_documents = [
    (master_doc, "nrtk-explorer.tex", "nrtk-explorer Documentation", "Kitware", "manual"),
]
...
man_pages = [(master_doc, "nrtk-explorer", "nrtk-explorer Documentation", [author], 1)]
